...
wget -qO- https://get.docker.com/ | sh && docker --version
#echo "显示docker版本号代表安装成功！！！"
echo "##############################docker安装成功！！！######################################"

wget https://ghproxy.com/https://github.com/docker/compose/releases/download/v2.16.0/docker-compose-linux-armv7 -O /usr/local/bin/docker-compose && chmod +x /usr/local/bin/docker-compose && docker-compose --version
#echo "显示docker版本号代表安装成功！！！"
